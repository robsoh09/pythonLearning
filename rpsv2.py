...
rewriting the game for name comparison bug 
...
player_b = input("Enter your name: ").strip() #remove whitespace left & right 
...
for x,y in first_player.items():
    for a, b in second_player.items(): 
        print(f"Player {x}, {y} will start first. Player {a}, {b} will be second ") 
